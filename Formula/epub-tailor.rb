class EpubTailor < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "89bcbbe970332db114f9d8970929f158a80fd67bdd7cbd6a3fe6d93568403abc"
    end

    on_intel do
      url "https://github.com/jordiboehme/epub-tailor/releases/download/v#{version}/epub-tailor-v#{version}-macos-intel.tar.gz"
      sha256 "ce754ec4b7a7d7710849114d24849376e852d8c1411cc841969957d03c15a5e3"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "245570869ea76b42467bee68c7f93f00e79d0de462a569301967d536444df90c"
    end

    on_intel do
      url "https://github.com/jordiboehme/epub-tailor/releases/download/v#{version}/epub-tailor-v#{version}-linux-amd64.tar.gz"
      sha256 "11049cbed4880a3c2be4370002137d024827addfb53a1b47859822cf4692cd26"
    end
  end
