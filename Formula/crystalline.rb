class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "2a6a3aadb9942287f5b5b8c41597730bb90a4b39c492959a5a5640cb6f295ea5"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "cf8cc096475fafbe4215e6550141f53dbad0e96067e3393fafa44204f47f380f"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "de60eb55260f0782d4852876a412ca5690bea7ebddd8c1b517d177b72c3b06d8"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "244a511d893df34b68449f89faea6f25400dc643d2e149a06d6f511d1aa84456"
    end
  end
