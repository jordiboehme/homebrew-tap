class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "b957b1ffebb60b8e7d24817fe239d983ffa8a2c13f33efda1ac62a293df59308"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "f45cc9036c2631dd23926901c80f5aad3bfba2620b93edabdee3a4b8ab9699b7"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "8a03899b1fff4acb8a2dc6ce34182c43aa4f749c223768dd4d2e7eda71a5587e"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "64e08fa764becfea4d484af219810893c60bb489e0b72d7f374c49bc5929f05a"
    end
  end
