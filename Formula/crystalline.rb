class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "4dbf8b1a5519db2e4857bd606002931db58050db712bf64760c1972c0ccf50df"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "92ff93cbf5f4ec932cc939fba9f9fcf49243e88e043a25dba38cd36bbc1da15c"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "9f95dbb2f4a05f9d4447e3845d01d4b51647e6ba3d678ec2981d789edb7772e5"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "1126e6b4c4318341dbb3c3039ff3ebfc6dc8438ba5499aa8bc83e7fb5ca9b6ca"
    end
  end
