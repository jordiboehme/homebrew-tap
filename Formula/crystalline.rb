class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "345f55eb1e3cfe5b7e42d6523542df9c798d57f1b2b5e74044f410953d67ebf9"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "c0dbc8ff2d586b82236ec28ce99eb044dba1941863d281275a9c50ea9d5580b4"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "e8ab599abbc41981462e7bf49a3c21bd5cbad3a7e879c29b996d52ec29b26fea"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "657c148900cf72e1a27b43cf0c4cddc283667808e7257ce6f4e2c63ce7e2dad0"
    end
  end
