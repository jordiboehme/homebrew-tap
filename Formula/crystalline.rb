class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "cf56c547bfc6435d14fc815fa2aa0614531ec46ef53f64e3c6494e3fb3954ea1"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "c6770a22115712d326e38d2c5bd49c4c71790663cffdc8761a149bc36b6ed9a2"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "a03661f843e888f1899bee842d55c0b4eab5a0dee47ebab2d09d9218ce80830d"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "0f1cbd8b28c121286deb9f4275ed80a034f23776068bcea8057cf0cb76426be0"
    end
  end
