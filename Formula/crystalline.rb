class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "8ad0a3c00c46292e2250422a0c640c7f663c5e0d7dcccfd8a4119ed3865d7814"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "1711324ec666de6c6e5dc8c807f9a62c9d5e1be15d7749b3ac7c602dd89741c2"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "50b3c5c75af0256e173595b4d6e9668b9c1591f413b637a36743d7cbddcae24e"
    end
  end
