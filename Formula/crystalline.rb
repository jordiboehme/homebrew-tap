class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "b0a8008f2567135151cb5bd40edf5ce66cd04dc72c71c8cc596e5653ada93a51"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "14047e8d1f9d8858d2d0efdb2bccd0bbee87f057e42f3448ed7460e9b02f9ba7"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "f5ba87bf64255cf259dc5c5e4ecab88cf9c491fbf93aa6a94d781c0e3770024f"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "df526c831ab4e3e438f8ac4b03e44618bc638d796af1d81d29c2e765d2fa866c"
    end
  end
