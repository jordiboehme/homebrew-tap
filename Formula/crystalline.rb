class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "2b79abebf9f8e77407e2b1d40642dbf59cf12965cabec0b95b89b287fe007ac0"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "a71b618cd73130484e836463e6f5a577a4c5b024bfe079c0ff64e70cf8a6f2e6"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "365618438d0cc09d36b7f735f6cb4fe261c25532926dbc337caa1d0764249d1a"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "f793f3d10ff506889957e20fa1cdd78e714b4f536395a6e01e61f7bea0b89a77"
    end
  end
