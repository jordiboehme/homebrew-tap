class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "306a5ec92424d7a0520bd312b1034d307df57b8965712370ea5878bf753b84af"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "aa5137a3f7d4e04866765c832e3269940166fd61b17432de73a4b353d839d188"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "624000bb881cc8b02acf8a0bfa02d092feb5999e3a3faa3a2f9d5bdc0922f875"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "020fe4628389189c3919f26006f74a016a7a0938dd4dca6acffaa3d8ee7028db"
    end
  end
