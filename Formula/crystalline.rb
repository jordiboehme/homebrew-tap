class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "ae81dc1d998ec136d1666de205b2c5c596da4931179e9c64cc955f9f847f25c0"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "511eede6efc3c7bacb892ba0210789193350efa0c9d4327826cbd622914d5054"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "1969d2ea0dcc86def3abd6fe095e794c2973ea36c56c774a75cbbaec60d34d78"
    end
  end
