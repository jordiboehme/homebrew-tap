class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "ca0e88c15c1a7bc15e9cdddd0dc60e6b087edf7be6c059f7c84798228babdc55"
    end

    on_intel do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-macos-intel.tar.gz"
      sha256 "e3c87dd1c4aab1a306313ce1629a66af55b346e2b37e3749798dfede3857594d"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "7ed220f6f22513a632049de2cd8956a6435792ef543c913b48289e9c7adf6c07"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "5345f32b6494a23ca326b85c33d827e1381578a2e43199ddba6a3e56e74d6cd0"
    end
  end
