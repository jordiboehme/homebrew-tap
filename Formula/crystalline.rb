class Crystalline < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "973e36ac7ae84360320f1d1d9dfdd710ebc0bb0d2771e83ca19e678349cd3c46"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "074f70f99fa32664c8611afb869b2d63b3630411165ffeb827a4ddf786fd4f48"
    end

    on_arm do
      url "https://github.com/jordiboehme/crystalline/releases/download/v#{version}/crystalline-v#{version}-linux-arm64.tar.gz"
      sha256 "bdd9c6ce882598cf95672fd7fc7a50110540c118f7471ca0c1f1fbd64c99869f"
    end
  end
